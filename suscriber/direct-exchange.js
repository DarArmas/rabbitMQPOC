...
const exchangeType = process.env.EXCHANGE_TYPE || 'direct';
const pattern = process.env.PATTERN || ''; //hace referencia a la routing key
//para exchange directos, la coincidencia debe ser exacta



console.log({queue, exchangeName, exchangeType, pattern});
